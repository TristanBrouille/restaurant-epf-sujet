...
public class PlatsService {
    ...
    public PlatsService(PlatRepository platRepository,
    ...
    public RecetteDto getRecette(Long id) {
        Plat plat = platRepository.ofId(id)
                .orElseThrow(() -> new RuntimeException(
                        "Plat introuvable : " + id));
        Map<Long, Double> ingredientIdQuantity = platIngredientRepository.ofPlatId(
                id);
        ...
        return new RecetteDto(plat.getId(), plat.getNom(),
                plat.getDescription(), plat.getPrix(),
                ingredients);
    }
}
