...
INSERT INTO INGREDIENT (nom, unite, stock_actuel, seuil_alerte)
VALUES ('Pate brisee', 'grammes', 500.0, 200.0),
...
VALUES ('Quiche Lorraine', 'Quiche traditionnelle aux lardons et fromage', 12.50),
...
VALUES (1, 1, 200.0), -- 200g pate brisee
       (1, 2, 3.0),   -- 3 oeufs
...
INSERT INTO PLAT_INGREDIENT (plat_id, ingredient_id, quantite_requise)
VALUES (3, 7, 400.0), -- 400g pommes de terre
...
VALUES ('Dupont', 'Alice', 'alice.dupont@email.fr', '0601020304'),
...
VALUES ('Metro Cash and Carry', 'Jean Leroy', 'commandes@metro.fr'),
...
INSERT INTO FOURNISSEUR_INGREDIENT (fournisseur_id, ingredient_id, prix_unitaire)
VALUES (1, 1, 0.06), -- Metro       : Pate brisee      0.06 €/g
